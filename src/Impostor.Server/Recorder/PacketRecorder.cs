...
internal class PacketRecorder : BackgroundService
{
    ...
    public PacketRecorder(ILogger<PacketRecorder> logger, IOptions<DebugConfig> options,
        ObjectPool<PacketSerializationContext> pool)
    {
    ...
    private void WritePacket(PacketSerializationContext context, IMessageReader reader, MessageType messageType)
    {
        ...
        context.Writer.Write(reader.Tag);
        context.Writer.Write(reader.Length);
