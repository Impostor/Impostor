...
public sealed class MatchmakerController(IOptions<ExtensionServerConfig> config, HttpConnectionManager connectionManager) : ControllerBase
{
    ...
    {
        if (!_config.EnabledWebSocketMatchmaker) return;
