...
internal partial class InnerGameData : InnerNetObject, IInnerGameData
{
    ...
    public InnerGameData(ICustomMessageManager<ICustomRpc> customMessageManager, Game game,
        ILogger<InnerGameData> logger, IEventManager eventManager, IServiceProvider serviceProvider) : base(
        ...
        bool initialState)
    {
        ...
        while (reader.Position < reader.Length)
        {
            ...
            var playerInfo = GetPlayerById(inner.Tag);
            if (playerInfo != null)
            {
