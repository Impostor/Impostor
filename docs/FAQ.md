...
See [Setting up your Server](Running-the-server) for more information on running the server and [Client Setup](http://impostor.github.io/Impostor/) for helping your friends join in!
